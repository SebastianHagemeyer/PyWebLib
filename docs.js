  ...
  var DOCS = [
    ...
    },
    {
      ...
      items: [
        ...
        { sig: 'game.sprite(skin, x, y, size=40, asset=False)', desc: 'A sprite you can move around. skin can be a built-in number (0 chicken, 1 dog, 2 bird, 3 egg, 4 coin, 5 basket, 6 shocked, 7 calm, 8 turtle, 9 car, 10 mouse, 11 rocket, 12 asteroid, 13 laser, 14 snake, 15 pacman, 16 ghost, 17 dino), its name like "chicken", or any emoji. Add asset=True to use a sprite you designed in the Asset studio, by its id number.', ex: 'hero = game.sprite("chicken", 100, 200)\nmine = game.sprite(5, 300, 200, asset=True)\nfoe  = game.sprite("🦖", 300, 200)' },
