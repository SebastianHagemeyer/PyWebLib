  ...
  var DOCS = [
    ...
    },
    {
      ...
      items: [
        ...
        { sig: 'sprite.anchor', desc: "Which point of the sprite sits on (x, y), as fractions of its art. The default (0.5, 0.5) is the middle; (0.5, 1) is the bottom middle, so the sprite stands with its feet on y; (0, 0) is the top-left corner. The collision box moves with it, so touches() and at_mouse() stay honest. Useful for a plant that should stand on the soil, or a cursor whose tip is the pointer.", ex: 'plant.anchor = (0.5, 1)     # stands on its feet\nplant.y = ground_y\n\ncan.anchor = (0.12, 0.7)    # the spout is the pointer' },
