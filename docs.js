  ...
  var DOCS = [
    ...
    },
    {
      ...
      items: [
        ...
        { sig: 'game.sprite(skin, x, y, size=40)', desc: 'A sprite you can move around. skin can be a built-in number (0 chicken, 1 dog, 2 bird, 3 egg, 4 coin, 5 basket, 6 shocked, 7 calm, 8 turtle, 9 car, 10 mouse, 11 rocket, 12 asteroid, 13 laser, 14 snake, 15 pacman, 16 ghost, 17 dino), its name like "chicken", or any emoji.', ex: 'hero = game.sprite("chicken", 100, 200)\nfoe  = game.sprite("🦖", 300, 200)' },
        ...
        { sig: 'game.game_over(message, retry=False)', desc: "Show a banner and stop the game. With retry=True a tap or click restarts the game from the top, so players don't have to press Run again (great on phones).", ex: 'game.game_over("Game over! Tap to play again", retry=True)' },
